  ...
  return (
    <div className="border border-gray-300 md:w-[800px] w-full mt-20 rounded-md p-4">
        ...
        <p className="text-gray-600 text-sm leading-10 mb-4">
          Make payment to account below and send proof of payment <b>( screenshot )</b> via
        ...
        <button className="bg-green-500 w-[250px] text-white font-semibold px-6 py-4 rounded-md hover:bg-green-600 transition"
        >
         Confirm Payment
        </button>
